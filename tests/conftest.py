...
def pytest_ignore_collect(collection_path, config):
    ...
    if not HAS_TENSORFLOW:
        ...
        tf_files = [
            ...
            "test_inf_abstract.py", "test_model_wrapper.py", "test_kfac_ihvp.py",
            "test_backend_tensorflow.py", "test_astra_ihvp.py",
            "test_first_order_influence_calculator.py",
            "test_query_batching.py",
