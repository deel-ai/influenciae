...
# =====================================================================================
"""
Tests for the influence calculator abstraction with PyTorch backend.
...
def test_instantiation():
    ...
    ihvp_objects = [
        ...
        ConjugateGradientDescentIHVP(influence_model, -1, train_loader),
        LissaIHVP(influence_model, -1, train_loader)
    ]
