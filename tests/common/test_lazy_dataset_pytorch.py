...
class TestLazyDatasetHelpers:
    """Tests for module-level helper utilities."""

    def test_ensure_reiterable_materializes_iterator(self, lazy_module):
    ...
    def test_ensure_reiterable_keeps_reiterable_inputs(self, lazy_module):
        """Re-iterable datasets should be returned unchanged."""
        data = [1, 2, 3]
        assert lazy_module.ensure_reiterable(data) is data

    def test_safe_len_and_is_iterator(self, lazy_module):
...
class TestMappedAndCachedDatasets:
    """Tests for mapped and cached wrappers."""

    def test_mapped_dataset_is_lazy_and_reiterable(self, lazy_module):
    ...
    def test_mapped_dataset_materializes_one_pass_iterator(self, lazy_module):
    ...
    def test_cached_dataset_is_stable(self, lazy_module):
...
class TestZipBatchUnbatchTakeAndShuffle:
    """Tests for composition wrappers."""

    def test_zipped_dataset_values_and_length(self, lazy_module):
    ...
    def test_batched_dataset_tuple_collation_and_tail_batch(self, lazy_module):
    ...
    def test_batched_dataset_list_collation(self, lazy_module):
    ...
    def test_batched_dataset_invalid_batch_size(self, lazy_module):
        """BatchedDataset should reject non-positive batch sizes."""
        with pytest.raises(ValueError):
            lazy_module.BatchedDataset([1, 2], batch_size=0)

    def test_unbatched_dataset_tuple_and_tensor(self, lazy_module):
    ...
    def test_unbatched_dataset_passes_through_non_batched_items(self, lazy_module):
    ...
    def test_taken_dataset_consumes_exact_count_and_caches(self, lazy_module):
    ...
    def test_taken_dataset_zero_count(self, lazy_module):
    ...
    def test_buffered_shuffle_dataset_invariants(self, lazy_module):
    ...
    def test_buffered_shuffle_dataset_materializes_one_pass_iterator(self, lazy_module):
    ...
    def test_buffered_shuffle_dataset_invalid_buffer(self, lazy_module):
