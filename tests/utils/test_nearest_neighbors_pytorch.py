...
def test_linear_nearest_pytorch(pytorch_backend):
    ...
    influences_values_expected = torch.tensor([[12, 10, 8, 6], [3., 2.5, 2., 1.5], [-1, -2, -3, -4]],
                                              dtype=torch.float32)
    training_samples_expected = torch.tensor([[[60, 60], [50, 50], [40, 40], [30, 30]],
...
def test_linear_nearest_pytorch_ascending(pytorch_backend):
    ...
    influences_values_expected = torch.tensor([[2, 4, 6, 8], [0.5, 1., 1.5, 2.], [-6, -5, -4, -3]],
                                              dtype=torch.float32)
    training_samples_expected = torch.tensor([[[10, 10], [20, 20], [30, 30], [40, 40]],
                                              [[10, 10], [20, 20], [30, 30], [40, 40]],
                                              [[60, 60], [50, 50], [40, 40], [30, 30]]], dtype=torch.float32)
