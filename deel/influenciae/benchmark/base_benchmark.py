...
from ..types import BackendLike, DatasetLike, Tensor
...
class MislabelingDetectorEvaluator:
    ...
    def __init__(
            ...
            backend: Optional[BackendLike] = None) -> None:
    ...
    @staticmethod
    def _resolve_backend(backend: Optional[BackendLike], dataset: DatasetLike) -> BaseBackend:
    ...
    @staticmethod
    def _load_pytorch_dependencies() -> Tuple[ModuleType, type]:
    ...
    def _extract_training_samples(self, data_loader_cls: type) -> List[Tuple[Any, Any]]:
    ...
    def _flip_label(self, label: Any, torch: ModuleType) -> Any:
    ...
    def _flip_torch_label(self, label: Any, torch: ModuleType) -> Any:
